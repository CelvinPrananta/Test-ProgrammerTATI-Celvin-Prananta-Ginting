...
@section('content')
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Hello World 3</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Hello World 3</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <form action="{{ route('tampilan-hello-world-3') }}" method="POST">
                        @csrf
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="kelipatan_hello_world"><h4 class="label-hello-world">Hello World ($n) :</h4></label>
                                <input type="text" class="form-control" name="kelipatan_bilangan" placeholder="Masukkan kelipatan bilangan">
                            </div>
                        </div>
    ...
    @section('script')
        <script>
            history.pushState({}, "", '/tampilan/hello/world/3');
        </script>
        
        <script>
            document.getElementById('pageTitle').innerHTML = 'Hello World 3 | Aplikasi Simpeg';
        </script>
