...
@section('content')
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Catatan Harian Kepala Bidang</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Catatan Harian Kepala Bidang</li>
                            </ul>
                        </div>
                        <div class="col-auto float-right ml-auto">
                            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#catatan_harian_kepalabidang"><i class="fa fa-plus"></i> Tambah Catatan Harian</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                    ...
                    @php
                        $lastCuti = $data_pribadi_kepalabidang->last();
                    @endphp
                    @if ($lastCuti)
                    ...
                    <!-- Search Filter -->
                    <form action="{{ route('catatan/harian/kepala-bidang/cari') }}" method="GET" id="search-form">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        @foreach($data_pribadi_kepalabidang as $sqlcutipribadi => $result_cuti_pribadi)
                                        <tr>
                                            {{-- <td>{{ ++$sqlcuti }}</td> --}}
                                                ...
                                                <div class="dropdown">
                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" id="statusDropdown" data-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        @elseif ($result_cuti_pribadi->persetujuan_kepala_bidang == 'Ditolak')
                                                            <i class="fa fa-dot-circle-o text-danger"></i>
                                                        @endif
                                                        <span class="dropdown_pengajuan">{{ $result_cuti_pribadi->persetujuan_kepala_bidang }}</span>
                                                    </a>
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if ($result_cuti_pribadi->status_pengajuan == 'Disetujui')
                                                            ...
                                                            <a class="dropdown-item delete_catatan_harian disabled" href="#" data-toggle="modal" data-target="#delete_catatan_harian"><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                                                        @elseif ($result_cuti_pribadi->status_pengajuan == 'Pending')
                ...
                <div id="catatan_harian_kepalabidang" class="modal custom-modal fade" role="dialog">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('catatan/harian/tambah-data') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        @foreach($data_profilkepalabidang_pribadi as $sqlcuti => $result_cuti)
    ...
    @section('script')
        ...
        <script>
            history.pushState({}, "", '/catatan/harian/kepala-bidang');
        </script>

        <script>
            document.getElementById('pageTitle').innerHTML = 'Catatan Harian - Kepala Bidang | Aplikasi Simpeg';
        </script>
